...
public class Application1 {
    public static void main(String[] args){
        ...
        * */
        ...
        //int result = num1 + num2; // 자동으로 큰 자료형인 long 타입으로 변경 후에 계산하기 떄문에 int형 변수에 값을 담을 수 없다.
        long result =num1 + num2; // int + long은 다른 자료형이라 데이터 손실이 발생하지 않는 int > long 변환을 자동으로 수행후 연산한다.
