...
public class Application3 {
    public static void main(String[] args){
        ...
        * */
        ...
        /* 목차 두 수의 연삭 결과를 int 형으로 변환 후 int 자료형 변수에 리턴받는다. */

        //int isum = inum + lnum;
        int isum = (int)(inum + lnum);

        /* 목차 2. long형 값은 int로 강제 형변환한다. */
        int isum2 = inum + (int)lnum;

        /* 목차 3. 결과값을 long으로 받는다. 자동형변환 */
        long lsum = inum + lnum;

        /* 주의사항 int미만의 연산 처리의 결과는 int 형이다. */
        byte bnum1 = 1;
        byte bnum2 = 2;
        short snum1 = 3;
        short snum2 =4;

        //short ssnum = bnum1 + snum1; // 에러발생
        //byte bsum = bnum1+bnum2; //에러발생
