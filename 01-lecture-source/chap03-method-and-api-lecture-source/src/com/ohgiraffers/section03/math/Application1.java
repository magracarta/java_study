...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 모든 코드를 우리가 다 외울수 없으니 API문서를 별도로 제공해주고 있다.
        * */
        ...
        * (객채의 상태를 관리하지 않고 기능만을 제공하는 경우 메모리를 효율적으로 사용하기 위해 자주 사용되는 기법이다.)
        * */

        
        /* 1. 절대값 */
        /* 1-1. 클래스의 풀네임을 다적은 경우 */
        ...
        /* 2. 최대값, 최솟값 출력 */
        System.out.println("10과 20중 더 적은 것은? : "+ Math.min(10,20));
        System.out.println("20과 30중 더 적은 것은? : "+ Math.max(20,30));
