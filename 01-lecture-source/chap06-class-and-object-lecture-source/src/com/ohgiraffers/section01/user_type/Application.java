...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < hobby.length; i++){
            String str = ", ";
            if(i == hobby.length-1) str = " ";
            System.out.print(hobby[i]+ str);
        }
        ...
        Member member2 = new Member(); //객체 생성(사용자 정의 변수명)

        /* 2-2. 생성된 인스턴스의 초기값 확인하기 */
        /*
         * 필드에 접근을 하기 위해서는 레퍼런스변수명.필드명
         * '.' 참조연산자라고 하는데 레퍼런스 변수가 참조하고 있는 주소로 접근한다는 의미를 가진다.
        ...
        for (int i=0; i < member.hobby.length; i++){
            String str = ", ";
            if(i == hobby.length-1) str = " ";
            System.out.print( member.hobby[i]+ str);
        }
