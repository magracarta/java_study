...
public class Application {
    public static void main(String[] args) {
        ...
        /*
        * 객체를 설계하기 위해서 복잡한 현실 세계를 그대로 반영하기엔 너무 방대하고 복잡하기 때문에
        ...
        * 확보하기 위함이다. 유연성 확보는 여러곳에 적용할 수 있는 유일한 객체를 의미하며, 즉, 재사용이 높아질 수 있다는
        ...
        * */
        ...
        /*
        * 시스템 요구사항
        * 1. 카레이서는 시동걸기, 엑셀 밟기, 브레이크 밟기, 시동끄기를 할 수있다.
        * */
