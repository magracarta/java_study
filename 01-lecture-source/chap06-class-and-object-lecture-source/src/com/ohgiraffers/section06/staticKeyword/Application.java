...
public class Application {
    public static void main(String[] args) {
        /* static 키워드에 대해 이해할 수있다. */
        /* static
        * : 정적 메모리 영역에 프로개름이 start될 때 할당하는 키워드이다.
        ...
        * static 필드의 경우에는 클래스 변수 자체가 프로그램이 종료할 때까지 유지되고 있기때문에
        * 값을 유지하고있다.
        * 따라서 여러 개의 인스턴스가 같은 값을(공간)을 공유할 목적으로 static 키워드를 사용한다.
        *
        * */
