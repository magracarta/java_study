...
public class Application1 {
    public static void main(String[] args) {
         ...
         *                   성능면에서 StingBuilder보다 느림
         *    두 개의 차이는 스레드 동기화 유무이고, 현재 우리는 스레드를 고혀하지 않기 때문에
         * StringBuilder를 이용할 것
         * */

        /*
         * Sting 과 StringBuilder
         * String : 불면이라는 특징을 가지고 있다.
        ...
        System.out.println("sb = "+ sb); //오버라이딩이 되어있다.

        /*
        * hashCode는 오버라이딩이 되어있지 않다.
        * 즉, 동일한 값을 가지는 경우 같은 해쉬코드를 반환하는 것이 아닌
        * 인스턴스가 동일해야아 같은 해쉬코드를 반환한다.
        * */
        ...
        //string과 달리 stringBuilder 는 안의 문자열이 달라져도 해시코드가 동일하다.
        System.out.println("sh.hashCode() = "+ sb.hashCode());
        sb.append("Oracle");
