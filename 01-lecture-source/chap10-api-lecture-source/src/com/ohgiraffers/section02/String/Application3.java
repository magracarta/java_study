...
public class Application3 {
    public static void main(String[] args) {
        ...
        // split에 limit 값을 음수로 추가하게 되는 경우 빈칸의 문자도 출력 된다.
        // 양수로 추가할 경우 --> 양수의 개수 만큼만 출력후 배열 합쳐버림
        ...
        while (st3.hasMoreTokens()){
            System.out.println("st2 : "+st3.nextToken());
        }
        ...
        //String[] color = colorStr.split("*#/ "); //에러
        // 대괄호를 사용하여 여러개의 조건으로 split을 할수 있다.
