...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 2. Data(long data) 사용하는 방법 */
        /* getTime() : 1970년 1월 1일 0시 0분 0초를 지난 시간을 millisecond로 계산해서 logn타입으로 반환한다. */

        System.out.println("today.getTime() = " + today.getTime()); //1712126991376
        Date time = new Date(1712126991376L);
