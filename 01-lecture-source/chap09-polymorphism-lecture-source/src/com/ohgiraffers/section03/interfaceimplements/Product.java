...
public class Product extends Object implements InterProduct , java.io.Serializable {
    ...
    * 단, extends 키워드를 앞에 작성하고 implements를 뒤에 작성한다. 순서가 바뀌면 에러 발생
    * */
    ...
    /* static 메소드는 오버라이딩 할 수 없다. , 작성은 가능 */
    /*
    @Override
    ...
    */
    ...
    /* default만 제거하면 오버라이딩이 가능하다. */
    @Override
    public void defaultMethod() {
        System.out.println("Product의 defaultMethod 호출된다.");
    }
