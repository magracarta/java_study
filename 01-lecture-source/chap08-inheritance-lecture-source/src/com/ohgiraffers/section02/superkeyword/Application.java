...
public class Application {
    public static void main(String[] args) {
        /* 수업목표. super와 super()에 대해 이해할 수있다.
        *
        * super : 자식클래스를 이용해서 객체를 생성할 때 부모 생성자를 호출하여 부모 클래스의
        *         인스턴스도 함게 생성하게 된다. 이 때 생성한 부모의 인스턴스 주소를 보관하는
        ...
        *           구문이라면 super()는 부모클래스가 가지는 private 생성자 제외한 나머지
        ...
        *  */
        ...
        Product produc2 = new Product("S-01234","삼성","갤럭시z폴드5",3590000,new Date());
        System.out.println("produc2 = " + produc2.getInformation());
        Computer computer1 = new Computer();
        System.out.println("computer1.getInformation() = " + computer1.getInformation());

        Computer computer2 = new Computer("릴컬 스냅드래곤",512,12,"안드로이드");

        System.out.println("computer2.toString() = " + computer2.toString());
        System.out.println("computer2.toString() = " + computer2.getInformation());

        Computer computer3 = new Computer("S-01234","삼성", "갤럭시Zv폴드5",259000,new java.util.Date() ,
                "릴컴 스냅드래곤", 512,12,"안드로이드"
        );
