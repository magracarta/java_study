...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * 배열을 할달 시에는 반드시 배열의 크기를 지정해 주어야한다.
        * */
        ...
        * */
        ...
        System.out.println("carr : "+crr2);  // 16진수 주소값
        ...
        * */
        System.out.println("iarr : "+ arr2.hashCode());
        System.out.println("carr : "+crr2.hashCode());

        System.out.println("arr2의 길이 : "+arr2.length);
        System.out.println("crr2의 길이 : "+ crr2.length);
        ...
        /* 메모리에 할당한 값은 지울수 없음.
           대신 참조형 변수를 사용하여 주소를 참조할 수 없게 만들수 있다. */
        /* 배열의 값을 끊어주고 싶을때는 null의 값을 사용한다. */
