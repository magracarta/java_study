...
public class Application1 {
    public static void main(String[] args) {
        /* 수업모굪. 다차원 배열의 구조를 이해하고 사용할 수 있다. */
        /*
        * 다차원 배열
        * 다차원 배열은 2차원 이상의 배열을 의마한다.
        * 배열의 인덱스마다 또 다른 배열의 주소를 보관하는 배열을 의미한다.
        * 즉, 2차원 배열은 1차원 배열 여러개를 하나로 묶어서 관리하는 배열을 의마한다.
        * 더 많은 차원의 배열을 사용할 수 있지만, 일반적으로 2차원 배열보다 높은 차원의 배열은 사용 반도가
        * 현저히 적다.
        *  */
        ...
        * 3. 각 인데스에 관리하는 배열을 할당 (heap)하여 주소를 보관하는 배열에 저장
